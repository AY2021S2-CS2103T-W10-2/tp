...
public class StorageManager implements Storage {
    ...
    private StoreMandoStorage storeMandoStorage;
    ...
    public void saveStoreMando(ReadOnlyStoreMando addressBook) throws IOException {
        saveStoreMando(addressBook, storeMandoStorage.getStoreMandoFilePath());
    }

    @Override
    public void saveStoreMando(ReadOnlyStoreMando addressBook, Path filePath) throws IOException {
        logger.fine("Attempting to write to data file: " + filePath);
        storeMandoStorage.saveStoreMando(addressBook, filePath);
    }
