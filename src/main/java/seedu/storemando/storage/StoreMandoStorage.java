...
public interface StoreMandoStorage {
     ...
     */
    void saveStoreMando(ReadOnlyStoreMando addressBook) throws IOException;

    /**
     * @see #saveStoreMando(ReadOnlyStoreMando)
     */
    void saveStoreMando(ReadOnlyStoreMando addressBook, Path filePath) throws IOException;
