...
import seedu.storemando.model.person.UniquePersonList;
...
public class StoreMando implements ReadOnlyStoreMando {
    ...
    /**
     * Creates an StoreMando using the Persons in the {@code toBeCopied}
     */
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
            ...
            && persons.equals(((StoreMando) other).persons));
    }
