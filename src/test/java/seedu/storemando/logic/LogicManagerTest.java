...
import static seedu.storemando.commons.core.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonStoreMandoStorage addressBookStorage =
            new JsonStoreMandoStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonStoreMandoStorage addressBookStorage =
            new JsonStoreMandoIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
